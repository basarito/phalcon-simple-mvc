...
<a href="<?= $this->url->get('') ?>" style="text-decoration: none">
...
<div class="row">
    <div class="col-md-4">
        ...
        <a href="<?= $this->url->get('member/view-all') ?>" style="text-decoration: none">
    ...
    <div class="col-md-4">
        ...
        <a href="<?= $this->url->get('member/new') ?>" style="text-decoration: none">
    ...
    <div class="col-md-4">
        ...
        <a href="<?= $this->url->get('search') ?>" style="text-decoration: none">
